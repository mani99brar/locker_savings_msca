export const ModularAccountAbi = [
  ...
  },
  {
    ...
    inputs: [
      { name: "data", type: "bytes", internalType: "bytes" },
      { name: "authorization", type: "bytes", internalType: "bytes" },
    ],
    ...
    outputs: [
      {
        ...
        components: [
          ...
          { name: "skipRuntimeValidation", type: "bool", internalType: "bool" },
          { name: "allowGlobalValidation", type: "bool", internalType: "bool" },
          {
            name: "executionHooks",
            type: "bytes25[]",
  ...
  },
  {
    ...
    inputs: [
      ...
      { name: "selectors", type: "bytes4[]", internalType: "bytes4[]" },
      { name: "installData", type: "bytes", internalType: "bytes" },
      { name: "hooks", type: "bytes[]", internalType: "bytes[]" },
    ],
    outputs: [],
    stateMutability: "nonpayable",
  },
  {
    ...
    inputs: [
        ...
        components: [
          ...
          },
          {
            ...
            components: [
              ...
              { name: "entityId", type: "uint32", internalType: "uint32" },
      ...
      { name: "moduleInstallData", type: "bytes", internalType: "bytes" },
    ],
    outputs: [],
    stateMutability: "nonpayable",
  },
  ...
  },
  {
    ...
    inputs: [
      { name: "value", type: "uint256", internalType: "uint256" },
      { name: "initCode", type: "bytes", internalType: "bytes" },
      { name: "isCreate2", type: "bool", internalType: "bool" },
      { name: "salt", type: "bytes32", internalType: "bytes32" },
    ],
    outputs: [
      { name: "createdAddr", type: "address", internalType: "address" },
    ],
    stateMutability: "payable",
  },
  {
  ...
  },
  {
    ...
    inputs: [
      ...
      { name: "moduleUninstallData", type: "bytes", internalType: "bytes" },
    ],
    outputs: [],
    stateMutability: "nonpayable",
  },
  {
    ...
    inputs: [
      ...
      { name: "uninstallData", type: "bytes", internalType: "bytes" },
      { name: "hookUninstallData", type: "bytes[]", internalType: "bytes[]" },
    ],
    outputs: [],
    stateMutability: "nonpayable",
  },
  ...
  { type: "error", name: "CreateFailed", inputs: [] },
  { type: "error", name: "DeferredActionSignatureInvalid", inputs: [] },
  { type: "error", name: "DeferredValidationHasValidationHooks", inputs: [] },
  {
    type: "error",
    name: "ExecutionHookAlreadySet",
    inputs: [
      { name: "hookConfig", type: "bytes25", internalType: "HookConfig" },
    ],
  },
  {
    type: "error",
  ...
  { type: "error", name: "NonCanonicalEncoding", inputs: [] },
  { type: "error", name: "NotEntryPoint", inputs: [] },
  { type: "error", name: "PreValidationHookDuplicate", inputs: [] },
  { type: "error", name: "RequireUserOperationContext", inputs: [] },
  { type: "error", name: "SegmentOutOfOrder", inputs: [] },
  { type: "error", name: "SelfCallRecursionDepthExceeded", inputs: [] },
  {
    type: "error",
  ...
  { type: "error", name: "ValidationAssocHookLimitExceeded", inputs: [] },
  { type: "error", name: "ValidationEntityIdInUse", inputs: [] },
  {
    type: "error",
    name: "ValidationFunctionMissing",
    inputs: [{ name: "selector", type: "bytes4", internalType: "bytes4" }],
  },
  { type: "error", name: "ValidationSignatureSegmentMissing", inputs: [] },
] as const;
