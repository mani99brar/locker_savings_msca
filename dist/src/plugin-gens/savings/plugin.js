...
const addresses = {
    11155111: "0x96BEFBae4867f7E8b0257d905E0E97f132b99DfC",
};
export const SavingsPlugin = {
    meta: {
...
export const savingsPluginActions = (client) => ({
    ...
    installSavingsPlugin({ account = client.account, overrides, context, ...params }) {
        ...
        const pluginAddress = params.pluginAddress ??
            SavingsPlugin.meta.addresses[chain.id];
        if (!pluginAddress) {
